...
<h2 style="color:white;text-align:center;">Employee pramotion  </h2>
</div>
"""
...
with col3:
    st.write('')
st.markdown("<h1 style='text-align: centre; color: black; font-size: 25px';>SHRADDHA </h1>", unsafe_allow_html=True)
